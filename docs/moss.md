...
Before using Moss, you must get a **Moss user id** and set your Moss user id in OJ. Read [this page](http://theory.stanford.edu/~aiken/moss) and register for Moss. You will receive a mail containing a perl script. Your user id is in that script.
...
Find your user id and use it in Sharif Judge for cheat detection. You don't need to put your user id in any file. Just save your user id in OJ's Moss page and OJ will use your user id in Moss perl script.
